...
=end
  ...
  def visit
    ...
    @browser.navigate.to "https://nowhiring.com/zinburger/job-details/33346948"
  ...
  def on_page?
    @browser.title == "Zinburger Wine & Burger Bar Host/Hostess Job in Charlottesville City, VA | Zinburger"
